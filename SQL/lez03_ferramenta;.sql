...
('Tavolino', 'Guida completa per la preparazione di piatti deliziosi', 'Libri', 29.99, '2018-09-15', 'OQB012'),
...
SELECT * FROM Oggetto WHERE categoria = "Accessori";

SELECT * FROM Oggetto WHERE categoria = "Accessori" AND prezzo >= 30;

SELECT * 
	FROM Oggetto 
    WHERE produzione >= "2019-01-01" AND produzione <= "2019-12-31";
    
SELECT *
	FROM Oggetto
    WHERE produzione BETWEEN "2019-01-01" AND "2019-12-31";
    
SELECT *
	FROM Oggetto
    WHERE categoria = "Accessori" OR categoria = "Scuola";
    
SELECT *
	FROM Oggetto
    WHERE nome LIKE "Panto%";
    
SELECT *
	FROM Oggetto
    WHERE nome LIKE "%fole";
